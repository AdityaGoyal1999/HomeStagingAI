  ...
  const faqs = [
    {
      ...
      answer: "Our AI analyzes your room photos and uses advanced machine learning to place realistic furniture, decor, and styling that matches the space's dimensions, lighting, and architectural features. The result is photorealistic staging that looks like professional interior design."
    },
    {
      question: "How long does it take to get staged photos?",
      answer: "Most staging requests are completed with a turnaround time of less than 15 seconds. Our AI processes photos instantly, so you'll typically have your staged images ready to use immediately."
    },
    {
      question: "What file formats do you accept and provide?",
      answer: "We accept JPG/JPEG, PNG, and WEBP files. We provide high-resolution images suitable for MLS listings, print marketing, and online advertising."
    },
    {
