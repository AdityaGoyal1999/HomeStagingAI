...
const plans = [
  ...
  // },
  {
    name: "All Inclusive",
    price: "$10",
    period: "/20 image generations",
    description: "Perfect for real estate agents, enthusiasts, and small businesses",
    features: [
      "Less than 15 seconds per image generation",
      "Dozens of design styles",
      "No hidden costs",
    ],
    cta: "Create an account now!",
    popular: false
  },
];
      ...
      <div className="container mx-auto flex flex-col items-center justify-center">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            No hidden charges with our simple pricing structure.
          </p>
        </div>
        
        <div className="max-w-6xl mx-auto bg-blue-100 w-[300px] items-center justify-center" style={{ marginTop: '2rem' }}>
